...
export const ModalSample = defineComponent({
  name: "KrdsModalSample",
  inheritAttrs: false,
  props: {
  ...
  setup(props, { attrs, emit, slots }) {
    const generatedId = `krds-modal-sample-${useId()}`;
    ...
    return () => {
      ...
      return create(
        "section",
        {
          ...
          ref: modalElement,
          id: id.value,
          class: ["krds-modal", "fade", open.value ? ["in", "shown"] : undefined, className],
          role: "dialog",
        ...
        [
          ...
          create("div", {
            class: ["modal-back", open.value ? "in" : undefined],
          }),
        ],
      );
    };
