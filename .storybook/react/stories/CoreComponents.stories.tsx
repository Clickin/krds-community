...
export const ButtonPrimary: Story = {
  ...
  parameters: {
    ...
    a11y: { test: 'error' },
    docs: { description: { story: 'React JSX에서 Button의 public API와 variant/size props를 사용합니다.' } },
  },
};
...
export const ButtonSecondary: Story = {
  ...
  parameters: {
    ...
    fixtureState: 'default',
    a11y: { test: 'error' },
    docs: { description: { story: 'React JSX에서 보조 작업용 secondary 버튼을 직접 렌더링합니다.' } },
  },
};
...
export const ButtonStates: Story = {
  ...
  parameters: {
    ...
    a11y: { test: 'error' },
    docs: { description: { story: '동일한 public API에서 native disabled semantics를 확인합니다.' } },
  },
};
...
export const TextInputDefault: Story = {
  ...
  render: (args) => <TextInput {...args} id="react-text-input-default" label="이름" hint="실명을 입력하세요." />,
  parameters: {
...
export const TextInputError: Story = {
  ...
  parameters: {
    ...
    a11y: { test: 'error' },
    docs: { description: { story: 'React JSX에서 state="error"를 사용해 invalid와 설명 관계를 확인합니다.' } },
  },
};
...
export const TextInputStates: Story = {
  ...
  render: () => (
    <div style={{ display: 'grid', gap: '1rem', maxWidth: 480 }}>
      <TextInput id="react-text-input-placeholder" label="검색" placeholder="검색어를 입력하세요." />
      <TextInput id="react-text-input-readonly" label="읽기 전용" defaultValue="고정 값" readOnly />
      <TextInput id="react-text-input-disabled" label="비활성" defaultValue="입력할 수 없음" disabled />
    </div>
  ),
  parameters: {
    fixtureId: 'text-input.default.medium',
    ...
    a11y: { test: 'error' },
    docs: { description: { story: 'React의 native input props로 placeholder, readonly, disabled 상태를 확인합니다.' } },
  },
};
...
export const CheckboxMedium: Story = {
  ...
  render: () => (
    <fieldset style={{ display: 'grid', gap: '.5rem' }}>
      <legend>약관 동의</legend>
      <Checkbox id="react-checkbox-medium-default" label="선택 안 함" name="react-checkbox-medium" />
      <Checkbox id="react-checkbox-medium-checked" label="선택됨" name="react-checkbox-medium" defaultChecked />
      <Checkbox id="react-checkbox-medium-disabled" label="비활성" name="react-checkbox-medium" disabled />
      <Checkbox
  ...
  parameters: {
    ...
    a11y: { test: 'error' },
    docs: { description: { story: 'React JSX에서 native checkbox의 checked/disabled 상태를 한 fixture 묶음으로 확인합니다.' } },
  },
};
...
export const CheckboxLarge: Story = {
  name: 'Checkbox · large',
  render: () => (
    <Checkbox id="react-checkbox-large" label="큰 체크박스" name="react-checkbox-large" size="large" />
  ),
  parameters: {
...
export const RadioMedium: Story = {
  ...
  render: () => (
    <fieldset style={{ display: 'grid', gap: '.5rem' }}>
      <legend>알림 빈도</legend>
      <Radio id="react-radio-medium-daily" label="매일" name="react-radio-medium" value="daily" defaultChecked />
      <Radio id="react-radio-medium-weekly" label="매주" name="react-radio-medium" value="weekly" />
      <Radio id="react-radio-medium-disabled" label="사용 안 함" name="react-radio-medium" value="none" disabled />
    </fieldset>
  ),
  parameters: {
    ...
    a11y: { test: 'error' },
    docs: { description: { story: 'React JSX에서 같은 name을 공유하는 native radio group을 사용합니다.' } },
  },
};
...
export const RadioLarge: Story = {
  name: 'Radio · large',
  render: () => (
    <Radio id="react-radio-large" label="큰 라디오" name="react-radio-large" value="large" size="large" />
  ),
  parameters: {
...
export const SwitchMedium: Story = {
  ...
  render: () => (
    <div style={{ display: 'grid', gap: '.5rem' }}>
      ...
      <Switch id="react-switch-medium-checked" label="자동 저장" name="react-switch-medium" defaultChecked />
      <Switch id="react-switch-medium-disabled" label="비활성" name="react-switch-medium" disabled />
    </div>
  ),
  parameters: {
    ...
    fixtureStates: ['default', 'checked', 'disabled', 'focus-visible'],
    a11y: { test: 'error' },
    docs: { description: { story: 'React JSX에서 native checkbox 기반 switch 상태를 확인합니다.' } },
  },
};
...
export const AccordionDefault: Story = {
  ...
  parameters: {
    ...
    a11y: { test: 'error' },
    docs: { description: { story: 'React JSX에서 Accordion items를 public API로 전달하며 클릭/키보드 상태를 검증합니다.' } },
  },
};
...
export const AccordionLine: Story = {
  ...
  render: () => (
    <Accordion
      type="line"
      items={[{ id: 'react-accordion-line', title: '라인 아코디언', content: '라인 안내 내용입니다.' }]}
    />
  ),
  parameters: {
...
export const TabDefault: Story = {
  ...
  render: () => (
    <Tab
      tabs={[{ id: 'react-tab-one', label: '첫 탭' }, { id: 'react-tab-two', label: '두 번째 탭' }]}
  ...
  parameters: {
    ...
    a11y: { test: 'error' },
    docs: { description: { story: 'React JSX에서 Tab tabs/panels public API와 선택 상태를 확인합니다.' } },
  },
};
...
export const FormInteraction: Story = {
  ...
  parameters: {
    ...
    a11y: { test: 'error' },
    docs: { description: { story: 'React JSX form에서 native input event와 submit 흐름을 play test로 확인합니다.' } },
  },
};
...
export const ModalDefault: Story = {
    ...
    function ModalExample() {
      ...
      return (
        <div>
          ...
          <Modal id="react-modal-default" open={open} title="확인 모달" onClose={() => setOpen(false)}>
            저장하시겠습니까?
          </Modal>
        </div>
      );
  ...
  parameters: {
    ...
    fixtureStates: ['default', 'focus-visible'],
    a11y: { test: 'error' },
    docs: { description: { story: 'React JSX에서 Modal open/onClose 흐름과 dialog accessible name을 확인합니다.' } },
  },
};
