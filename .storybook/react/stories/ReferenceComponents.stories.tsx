...
const fixture = (
  ...
  fixtureStates: string[] = ["default", "focus-visible"],
) => ({
  ...
  return (
    <section aria-label="Actions reference" style={stackStyle}>
      ...
      <div style={rowStyle}>
        ...
        <ButtonText className="small" disabled={args.disabled}>
          텍스트 버튼
        </ButtonText>
        <ButtonWithIcon className="xsmall" disabled={args.disabled}>
          아이콘 버튼
        </ButtonWithIcon>
      </div>
      <div style={rowStyle}>
    ...
    <section aria-label="Choice controls reference" style={stackStyle}>
      <fieldset>
        ...
        <div style={rowStyle}>
          ...
          />
          <CheckboxChip
            id="reference-checkbox-chip"
            name="reference-checkbox-chip"
            label="체크 칩"
          />
          <Switch
            id="reference-switch"
      ...
      <fieldset>
        ...
        <div style={rowStyle}>
          ...
          />
          <RadioButton
            id="reference-radio-button"
            name="reference-radio-button"
            value="button"
            label="라디오 버튼"
          />
          <RadioSize
            id="reference-radio-size"
            name="reference-radio-size"
            value="medium"
            label="라디오 사이즈"
            size="medium"
          />
  ...
  return (
    ...
    >
      ...
      <div style={rowStyle}>
        ...
        <Button type="button" onClick={() => setValue("재설정")}>
          값 재설정
        </Button>
      </div>
      <output aria-live="polite">
        현재 값: {value}; 선택: {checked ? "예" : "아니오"}
      </output>
    </form>
  );
}
