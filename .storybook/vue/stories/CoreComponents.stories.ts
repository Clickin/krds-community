...
export const ButtonSecondary: Story = {
  ...
  render: () => ({
    setup: () => () => h(Button, { variant: "secondary" }, { default: () => "보조 작업" }),
  }),
  parameters: {
...
export const ButtonTertiary: Story = {
  ...
  render: () => ({
    setup: () => () => h(Button, { variant: "tertiary" }, { default: () => "취소" }),
  }),
  parameters: {
...
export const TextInputStates: Story = {
  ...
  render: () => ({
    setup: () =>
      h("div", { style: "display:grid;gap:1rem;max-width:30rem" }, [
        h(TextInput, {
          id: "vue-text-input-placeholder",
          label: "검색",
          placeholder: "검색어를 입력하세요.",
        }),
        h(TextInput, {
          id: "vue-text-input-readonly",
          label: "읽기 전용",
          defaultValue: "고정 값",
          readonly: true,
        }),
        h(TextInput, {
          id: "vue-text-input-disabled",
          label: "비활성",
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: "Vue native input props로 placeholder/readonly/disabled 상태를 확인합니다.",
      },
    },
  },
};
...
export const CheckboxMedium: Story = {
  ...
  render: () => ({
    setup: () =>
      h("fieldset", { style: "display:grid;gap:.5rem" }, [
        h("legend", "약관 동의"),
        h(Checkbox, {
          id: "vue-checkbox-medium-default",
          label: "선택 안 함",
          name: "vue-checkbox-medium",
        }),
        h(Checkbox, {
          id: "vue-checkbox-medium-checked",
          label: "선택됨",
          name: "vue-checkbox-medium",
          defaultChecked: true,
        }),
        h(Checkbox, {
          id: "vue-checkbox-medium-disabled",
          label: "비활성",
          name: "vue-checkbox-medium",
          disabled: true,
        }),
        h(Checkbox, {
          id: "vue-checkbox-medium-disabled-checked",
          label: "비활성 선택됨",
          name: "vue-checkbox-medium",
          disabled: true,
          defaultChecked: true,
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: "Vue public API에서 checkbox 상태와 native label relation을 확인합니다.",
      },
    },
  },
};
  ...
  render: () => ({
    setup: () => () =>
      h("fieldset", { style: "display:grid;gap:.5rem" }, [
        h("legend", "알림 빈도"),
        h(Radio, {
          id: "vue-radio-medium-daily",
          label: "매일",
          name: "vue-radio-medium",
          value: "daily",
          defaultValue: "daily",
        }),
        h(Radio, {
          id: "vue-radio-medium-weekly",
          label: "매주",
          name: "vue-radio-medium",
          value: "weekly",
        }),
        h(Radio, {
          id: "vue-radio-medium-disabled",
          label: "사용 안 함",
          name: "vue-radio-medium",
          value: "none",
          disabled: true,
...
export const SwitchMedium: Story = {
  ...
  render: () => ({
    setup: () =>
      h("div", { style: "display:grid;gap:1rem;max-width:30rem" }, [
        h(Switch, {
          id: "vue-switch-medium-default",
          label: "알림 받기",
          name: "vue-switch-medium",
        }),
        h(Switch, {
          id: "vue-switch-medium-checked",
          label: "자동 저장",
          name: "vue-switch-medium",
          defaultChecked: true,
        }),
        h(Switch, {
          id: "vue-switch-medium-disabled",
          label: "비활성",
          name: "vue-switch-medium",
          disabled: true,
        }),
...
export const AccordionDefault: Story = {
  ...
  parameters: {
    ...
    a11y: { test: "error" },
    docs: {
      description: { story: "Vue render function에서 Accordion items를 public API로 전달합니다." },
    },
  },
};
  ...
  render: () => ({
    setup: () =>
      h(Accordion, {
        type: "line",
        items: [
          { id: "vue-accordion-line", title: "라인 아코디언", content: "라인 안내 내용입니다." },
        ],
      }),
  }),
  parameters: {
...
export const TabDefault: Story = {
  ...
  render: () => ({
    setup: () =>
      h(Tab, {
        tabs: [
          { id: "vue-tab-one", label: "첫 탭" },
          { id: "vue-tab-two", label: "두 번째 탭" },
        ],
  ...
  parameters: {
    ...
    a11y: { test: "error" },
    docs: {
      description: { story: "Vue render function에서 Tab tabs/panels와 선택 상태를 확인합니다." },
    },
  },
};
...
export const FormInteraction: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: "Vue render function에서 native form 이벤트와 submit 흐름을 검증합니다.",
      },
    },
  },
};
...
export const ModalDefault: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: "Vue render function에서 Modal openChange와 dialog accessible name을 확인합니다.",
      },
    },
  },
};
