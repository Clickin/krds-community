...
export const ButtonPrimary: Story = {
  ...
  parameters: {
    ...
    a11y: { test: "error" },
    docs: { description: usage("Svelte markup에서 Button public props를 사용합니다.").description },
  },
};
...
export const ButtonSecondary: Story = {
  ...
  parameters: {
    ...
    a11y: { test: "error" },
    docs: {
      description: usage("Svelte markup에서 secondary 버튼을 직접 렌더링합니다.").description,
    },
  },
};
...
export const ButtonTertiary: Story = {
  ...
  parameters: {
    ...
    a11y: { test: "error" },
    docs: {
      description: usage("Svelte markup에서 tertiary 버튼을 직접 렌더링합니다.").description,
    },
  },
};
...
export const ButtonStates: Story = {
  ...
  parameters: {
    ...
    a11y: { test: "error" },
    docs: {
      description: usage("Svelte public component에서 native disabled semantics를 확인합니다.")
        .description,
    },
  },
};
...
export const TextInputDefault: Story = {
  ...
  parameters: {
    ...
    a11y: { test: "error" },
    docs: {
      description: usage("Svelte markup에서 label과 hint relation을 확인합니다.").description,
    },
  },
};
...
export const TextInputError: Story = {
  ...
  parameters: {
    ...
    a11y: { test: "error" },
    docs: { description: usage('Svelte에서 state="error"와 hint를 직접 지정합니다.').description },
  },
};
...
export const TextInputSuccess: Story = {
  ...
  parameters: {
    ...
    fixtureState: "default",
    a11y: { test: "error" },
    docs: { description: usage("Svelte에서 success 상태를 직접 지정합니다.").description },
  },
};
...
export const TextInputInformation: Story = {
  ...
  parameters: {
    ...
    fixtureState: "default",
    a11y: { test: "error" },
    docs: { description: usage("Svelte에서 information 상태를 직접 지정합니다.").description },
  },
};
...
export const CheckboxMedium: Story = {
  ...
  parameters: {
    ...
    a11y: { test: "error" },
    docs: {
      description: usage("Svelte markup에서 native checkbox 상태와 label relation을 확인합니다.")
        .description,
    },
  },
};
...
export const CheckboxLarge: Story = {
  ...
  parameters: {
    ...
    a11y: { test: "error" },
    docs: {
      description: usage('Svelte에서 size="large" checkbox를 직접 렌더링합니다.').description,
    },
  },
};
...
export const RadioMedium: Story = {
  ...
  parameters: {
    ...
    a11y: { test: "error" },
    docs: {
      description: usage("Svelte markup에서 같은 name을 공유하는 radio group을 사용합니다.")
        .description,
    },
  },
};
...
export const RadioLarge: Story = {
  ...
  parameters: {
    ...
    fixtureState: "default",
    a11y: { test: "error" },
    docs: { description: usage('Svelte에서 size="large" radio를 직접 렌더링합니다.').description },
  },
};
...
export const SwitchMedium: Story = {
  ...
  parameters: {
    ...
    a11y: { test: "error" },
    docs: {
      description: usage("Svelte native checkbox 기반 switch 상태를 확인합니다.").description,
    },
  },
};
...
export const SwitchLarge: Story = {
  ...
  parameters: {
    ...
    fixtureState: "default",
    a11y: { test: "error" },
    docs: { description: usage('Svelte에서 size="large" switch를 직접 렌더링합니다.').description },
  },
};
...
export const AccordionDefault: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: usage(
        "Svelte markup에서 Accordion items를 전달하며 keyboard/click 상태를 확인합니다.",
      ).description,
    },
  },
};
...
export const AccordionLine: Story = {
  ...
  parameters: {
    ...
    a11y: { test: "error" },
    docs: {
      description: usage('Svelte markup에서 type="line" variant를 직접 지정합니다.').description,
    },
  },
};
...
export const TabDefault: Story = {
  ...
  parameters: {
    ...
    a11y: { test: "error" },
    docs: {
      description: usage("Svelte markup에서 Tab tabs/panels와 선택 상태를 확인합니다.").description,
    },
  },
};
...
export const FormInteraction: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: usage(
        "Svelte markup에서 native form event와 submit 흐름을 play test로 검증합니다.",
      ).description,
    },
  },
};
...
export const ModalDefault: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: usage(
        "Svelte markup에서 Modal open/close와 dialog accessible name을 확인합니다.",
      ).description,
    },
  },
};
