...
export const StructuredListTable: Story = {
  ...
  args: { component: 'StructuredListTable', componentProps: structuredTableProps, eventLabel: '구조화 표' },
  parameters: { ...fixtureParameters('structured-list-table.default', ['default', 'focus-visible']) },
};
  ...
  args: {
    ...
    componentProps: {
      ...
      rows: [
        ...
        { title: '제목1-3', content: Array.from({ length: 4 }, () => '내용이 들어갑니다.').join(' ') },
      ],
    },
    eventLabel: '표',
  },
