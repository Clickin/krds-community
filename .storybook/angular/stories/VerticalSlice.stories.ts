...
export const Default: StoryObj<typeof meta> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Angular standalone imports와 ReactiveFormsModule을 이용해 실제 form workflow를 구성합니다. 컴포넌트 입력은 property binding으로 전달하고 submit interaction을 play test로 확인합니다.',
      },
    },
  },
};
